...
function AppRoutes() {
  return _jsxs(Routes, {
    children: [
      ...
      _jsx(Route, { path: '/registro', element: _jsx(RegisterPage, {}) }),
      _jsx(Route, {
        path: '/inventario',
        element: _jsx(AuthGuard, { children: _jsx(InventoryPage, {}) }),
      }),
      _jsx(Route, {
        path: '/lista',
        element: _jsx(AuthGuard, {
          children: _jsx(RoleGuard, {
            allowedRoles: ['admin', 'encargado'],
            children: _jsx(ShoppingListPage, {}),
          }),
        }),
      }),
      _jsx(Route, {
      ...
      _jsx(Route, {
        path: '/productos',
        element: _jsx(AuthGuard, {
          children: _jsx(RoleGuard, { allowedRoles: ['admin'], children: _jsx(ProductsPage, {}) }),
        }),
      }),
      _jsx(Route, {
      ...
      _jsx(Route, {
        path: '/usuarios',
        element: _jsx(AuthGuard, {
          children: _jsx(RoleGuard, { allowedRoles: ['admin'], children: _jsx(UsersPage, {}) }),
        }),
      }),
      _jsx(Route, {
        ...
        element: _jsx(AuthGuard, {
          children: _jsx(RoleGuard, {
            allowedRoles: ['admin'],
            children: _jsx(ProductAssignmentPage, {}),
          }),
        }),
      }),
      _jsx(Route, { path: '/', element: _jsx(Navigate, { to: '/inventario', replace: true }) }),
      _jsx(Route, { path: '*', element: _jsx(Navigate, { to: '/inventario', replace: true }) }),
    ],
  });
}
