  ...
  return _jsx(Layout, {
    ...
    children: _jsxs('div', {
      ...
      children: [
            ...
            children: [
              ...
              listOpen &&
                ...
                _jsx('div', {
                  ...
                  children: 'Todos los productos est\u00E1n sobre el stock m\u00EDnimo.',
                }),
            ],
          }),
        _jsxs('div', {
          ...
          children: [
              ...
              children: [
                _jsxs('svg', {
                  ...
                  children: [
                    ...
                    _jsx('line', { x1: '21', y1: '21', x2: '16.65', y2: '16.65' }),
                  ],
                }),
                _jsx('input', {
                  type: 'text',
            ...
            _jsx(BarcodeScannerButton, { onScan: handleBarcodeScan }),
          ],
        }),
        barcodeError &&
          _jsx('div', {
                      ...
                      _jsxs('form', {
                        ...
                        children: [
                                  ...
                                  _jsxs('label', {
                                    ...
                                    children: [
                                      ...
                                      _jsxs('span', {
                                        ...
                                        children: ['(', product.packageUnit, ')'],
                                      }),
                                    ],
                                  }),
                                  _jsx('div', {
                                    style: { display: 'flex', gap: '8px' },
                                    children: QUICK_COUNTS.map((n) =>
                                      _jsx(
                                        'button',
                                        {
                                          type: 'button',
                                          ...
                                          style: {
                                            ...
                                            backgroundColor:
                                              packageCount === n
                                                ...
                                                : colors.surface,
                                            color:
                                              packageCount === n ? colors.primary : colors.text,
                                            fontSize: '18px',
                                            fontWeight: 700,
                                            cursor: 'pointer',
                                  ...
                                  _jsxs('div', {
                                    ...
                                    children: [
                                      ...
                                      _jsxs('span', {
                                        ...
                                        children: ['= ', calcQty, ' ', product.unitLabel],
                                      }),
                                    ],
                                  }),
                                ],
                          ...
                          _jsx('button', {
                            ...
                            children: saving ? 'Guardando...' : 'Registrar Compra',
                          }),
                        ],
                      }),
                  ],
        ...
        _jsx(PurchaseHistory, { items: history, loading: loadingHistory }),
      ],
    }),
  });
}
