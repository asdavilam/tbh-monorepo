        ...
        _jsxs('div', {
          ...
          children: [
            ...
            _jsxs('div', {
              ...
              children: [
                ...
                _jsxs('select', {
                  ...
                  children: [
                    _jsx('option', { value: '', children: 'Sin asignar' }),
            ...
            _jsx('button', {
              ...
              style: {
                backgroundColor:
                  selectedProductIds.size === 0 ? colors.surfaceHigh : colors.primary,
            ...
            saveSuccess &&
              _jsx('div', {
                ...
                children: 'Productos asignados correctamente',
              }),
          ],
        }),
        _jsxs('div', {
          ...
          children: [
            _jsx('label', {
              style: { fontSize: fontSize.sm, fontWeight: 700, color: colors.text },
              children: 'Filtrar por asignaci\u00F3n actual',
            }),
            _jsxs('select', {
              value: filterUserId,
              onChange: (e) => {
              ...
              children: [
                _jsx('option', { value: 'all', children: 'Todos los productos' }),
                _jsx('option', { value: 'none', children: 'Sin asignar' }),
                users.map((u) => _jsx('option', { value: u.id, children: u.name }, u.id)),
              ],
            }),
          ],
                ...
                _jsxs('div', {
                  ...
                  children: [
                    ...
                    _jsxs('div', {
                      ...
                      children: [
                        _jsx('span', { children: PRODUCT_TYPE_LABELS[product.type] }),
                        _jsx('span', { children: '\u00B7' }),
                        _jsx('span', {
                          style: {
                          ...
                          children: getUserName(product.assignedUserId),
                        }),
                      ],
                    }),
                  ],
