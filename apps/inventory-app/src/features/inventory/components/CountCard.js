          ...
          children: [
            ...
            _jsxs('div', {
              children: [
                ...
                _jsx('p', {
                  style: { margin: '2px 0 0', fontSize: fontSize.sm, color: colors.textMuted },
        ...
        _jsxs('div', {
          ...
          children: [
            _jsx('p', {
              ...
              children: isQualitative ? savedRecord.qualitativeValue : savedRecord.finalCount,
            }),
            !isQualitative &&
              _jsxs('p', {
                style: {
      ...
      _jsx('div', {
        ...
        children: isQualitative
          ...
          : _jsxs('div', {
              ...
              children: [
                item.unitType === 'fraction' &&
                  item.packageSize &&
                  _jsx('div', {
                    style: { display: 'flex', gap: '6px' },
                    children: FRACTION_OPTIONS.map((opt) => {
                  ...
                  children: [
                    ...
                    finalCount &&
                      ...
                      _jsxs('span', {
                        ...
                        children: [liveDifference > 0 ? '+' : '', liveDifference],
                      }),
                  ],
                }),
                item.unitType === 'fraction' &&
                  ...
                  finalCount &&
                  _jsxs('span', {
                    style: { fontSize: '11px', color: colors.textMuted, fontWeight: 600 },
                    children: ['= ', finalCount, ' ', item.unitLabel],
                  }),
              ],
            }),
      }),
